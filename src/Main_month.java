...
public class Main_month {
    ...
    private static void prepara_cenarios(Dados_password[] entrada, String type) throws IOException {
        ...
        //Para insertionSort
        // Ordena melhor caso
        Algoritmos_ordenacao_month.algoritmo_ordena(melhorCaso);
        ...
        // Reverter o array ordenado para pior caso
        inverter_array(melhorCaso);
        piorCaso = melhorCaso.clone();
    ...
    private static void ordenar(Dados_password[] entrada, String type, String metodo_ordencao, String cenario) throws IOException {
        ...
        switch (metodo_ordencao) {
            case "insertionSort":
                ...
                Algoritmos_ordenacao_month.insertionSort(entrada);
            ...
            case "bubbleSort":
                ...
                Algoritmos_ordenacao_month.bubbleSort(entrada);
            ...
            case "selectionSort":
                ...
                Algoritmos_ordenacao_month.selectionSort(entrada);
            ...
            case "quickSort":
                ...
                Algoritmos_ordenacao_month.quickSort(entrada);
            ...
            case "quickSortMedianaDeTres":
                ...
                Algoritmos_ordenacao_month.quickSortMedianaDeTres(entrada);
            ...
            case "heapSort":
                ...
                Algoritmos_ordenacao_month.heapSort(entrada);
            ...
            case "mergeSort":
                ...
                Algoritmos_ordenacao_month.mergeSort(entrada);
            ...
            case "countingSort":
                ...
                Algoritmos_ordenacao_month.countingSort(entrada);
