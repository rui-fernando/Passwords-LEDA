...
public class Main_length{
    ...
    private static void prepara_cenarios(Dados_password[] entrada, String type) throws IOException {
        ...
        //Para insertionSort
        // Ordena melhor caso
        Algoritmos_ordenacao_length.algoritmo_ordena(melhorCaso);
    ...
    private static void ordenar(Dados_password[] entrada, String type, String metodo_ordencao, String cenario) throws IOException {
        ...
        switch (metodo_ordencao) {
            case "insertionSort":
                ...
                Algoritmos_ordenacao_length.insertionSort(entrada);

                long endTime = System.nanoTime(); // Finaliza teùpo
            ...
            case "bubbleSort":
                ...
                Algoritmos_ordenacao_length.bubbleSort(entrada);
            ...
            case "selectionSort":
                ...
                Algoritmos_ordenacao_length.selectionSort(entrada);
            ...
            case "quickSort":
                ...
                Algoritmos_ordenacao_length.quickSort(entrada);
            ...
            case "quickSortMedianaDeTres":
                ...
                Algoritmos_ordenacao_length.quickSortMedianaDeTres(entrada);
            ...
            case "heapSort":
                ...
                Algoritmos_ordenacao_length.heapSort(entrada);
            ...
            case "mergeSort":
                ...
                Algoritmos_ordenacao_length.mergeSort(entrada);
            ...
            case "countingSort":
                ...
                Algoritmos_ordenacao_length.countingSort(entrada);
