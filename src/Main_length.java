...
public class Main_length{
    public static void main(String[] args) throws IOException {
        ...
        prepara_cenarios(entrada, "length");
    }
    ...
    private static void prepara_cenarios(ListaEncadeada<Dados_password> entrada, String type) throws IOException {
        ...
        salvar(melhorCaso, "dados_saida/passwords_melhorCaso_entrada_length.csv");
        ListaEncadeada<Dados_password>  medioCaso = copiarLista(entrada);
        mistura_lista(medioCaso, new Random());
        salvar(medioCaso, "dados_saida/passwords_medioCaso_entrada_length.csv");
        ListaEncadeada<Dados_password>  piorCaso = copiarLista(melhorCaso);
        inverter_lista(piorCaso);
        salvar(piorCaso, "dados_saida/passwords_piorCaso_entrada_length.csv");
        ...
        salvar(melhorCaso, "dados_saida/passwords_melhorCaso_saida_length.csv");
        salvar(medioCaso, "dados_saida/passwords_medioCaso_saida_length.csv");
        salvar(piorCaso, "dados_saida/passwords_piorCaso_saida_length.csv");
    }
    ...
    private static void ordenar(ListaEncadeada<Dados_password>  entrada, String type, String metodo_ordencao, String cenario) throws IOException {
        ...
        switch (metodo_ordencao) {
            case "insertionSort":
                    ...
                    ListaEncadeada<Dados_password>  insertionSort_ordenado = Algoritmos_ordencao_length.insertionSort(entrada);
            ...
            case "bubbleSort":
                    ...
                    ListaEncadeada<Dados_password> bubbleSort_ordenado = Algoritmos_ordencao_length.bubbleSort(entrada);
            ...
            case "selectionSort":
                    ...
                    ListaEncadeada<Dados_password> selectionSort_ordenado = Algoritmos_ordencao_length.selectionSort(entrada);
            ...
            case "quickSort":
                ...
                ListaEncadeada<Dados_password> quickSort_ordenado = Algoritmos_ordencao_length.quickSort(entrada);
            ...
            case "quickSortMedianaDeTres":
                ...
                ListaEncadeada<Dados_password> quickSortMedianaDeTres_ordenado = Algoritmos_ordencao_length.quickSortMedianaDeTres(entrada);
            ...
            case "heapSort":
                    ...
                    ListaEncadeada<Dados_password> heapSort_ordenado = Algoritmos_ordencao_length.heapSort(entrada);
            ...
            case "mergeSort":
                    ...
                    ListaEncadeada<Dados_password> mergeSort_ordenado = Algoritmos_ordencao_length.mergeSort(entrada);
            ...
            ListaEncadeada<Dados_password> countingSort_ordenado = Algoritmos_ordencao_length.countingSort(entrada);
    ...
    public static void algoritmo_ordena(ListaEncadeada<Dados_password> lista) {
        for (int i = 1; i < lista.tamanho(); i++) {
            ...
            while (j >= 0 && lista.buscar(j).getLength() < aux.getLength()) {
